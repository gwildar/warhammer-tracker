...
export const MAGIC_ITEMS = [
  ...
  },
  {
    ...
    points: 15,
    effect:
      'Knightly Order. Must equip great weapons or halberds (may replace with wolf hammers for free). Gains Furious Charge (+1 Attacks on charge of 3"+). Inner Circle gains 5+ Ward vs Flaming Attacks.',
    phases: ["combat"],
  },
  {
    ...
    points: 15,
    effect:
      "Knightly Order. Gains Hatred (enemy Wizards, Orcs & Goblins) and +1 Initiative first round of combat. Inner Circle may re-roll To Hit or To Wound rolls of natural 1.",
    phases: ["combat"],
  },
  {
    ...
    points: 15,
    effect:
      "Knightly Order. Gains Hatred (Undead) and 6+ Ward save vs non-magical attacks. Inner Circle gains Fear and Magical Attacks.",
    phases: ["combat", "shooting"],
    ward: "6+",
  },
  {
    ...
    points: 10,
    effect:
      "Knightly Order. Gains Evasive and Flaming Attacks. Inner Circle may claim +1 combat result point on a turn it charged.",
    phases: ["combat", "shooting"],
  },
  {
    ...
    points: 10,
    effect:
      "Knightly Order. Must be armed with lances. May re-roll a single natural 1 on Charge rolls. Gains Hatred (Warriors of Chaos, Beastmen, Daemons). Inner Circle gains Magic Resistance (-1).",
    phases: ["combat"],
  },
  {
