      ...
      <header class="bg-wh-surface border-b border-wh-border p-3">
        <div class="flex justify-between items-center mb-2">
          <div class="flex items-center gap-2">
            ...
            ${army.owbId ? `<a href="https://old-world-builder.com/game-view/${army.owbId}" target="_blank" rel="noopener noreferrer" class="text-xs text-wh-muted hover:text-wh-green border border-wh-green px-2 py-1 rounded transition-colors" title="View in Old World Builder">&#128065;</a>` : ""}
          </div>
